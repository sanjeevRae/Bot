 ...
 * tabs (and inside the "All" overview) without duplicating the feature. The only
 * addition is the optional `preview` prop, which caps the list and offers a
 * "View all" link that switches the Engagement tab.
 */
